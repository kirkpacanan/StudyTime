-- StudyTime: Social system repair — relationships, study buddies, search, notifications.
...
-- ============================================================================
-- 3. Profile RPCs — relationship states, friend count, study buddy card
-- ============================================================================
...
-- ============================================================================
-- 4. Friend RPC improvements — cancel outgoing, return errors, cleanup buddies
-- ============================================================================
...
-- Return type changed from void → jsonb; Postgres requires DROP first.
drop function if exists public.remove_friend(uuid);
drop function if exists public.block_user(uuid);
