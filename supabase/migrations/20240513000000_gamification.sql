...
insert into public.cosmetics (id, type, name, rarity, unlock_level, unlock_prestige, animated) values
  ...
  ('frame_apprentice', 'frame', 'Emerald Ring', 'common', 6, null, false),
  ('frame_locked_in', 'frame', 'Locked-In Glow', 'rare', 11, null, false),
  ('frame_main_animated', 'frame', 'Animated Aura', 'epic', 16, null, true),
  ('frame_professor', 'frame', 'Prismatic Pulse', 'epic', 31, null, true),
